...
public class ItemBlackOsmiumWandCap extends Item
{
	public int SUBTYPES = 2;
	public IIcon[] icons = new IIcon[SUBTYPES];

	public ItemBlackOsmiumWandCap ()
	{
		this.setCreativeTab(DGMain.dgTab);
		this.setUnlocalizedName("ItemBlackOsmiumWandCap");
	...
	public void registerIcons (IIconRegister ir)
	{
		for (int i = 0; i < icons.length; i++)
			this.icons[i] = ir.registerIcon("dg:ItemBlackOsmiumWandCap" + i);
	}
