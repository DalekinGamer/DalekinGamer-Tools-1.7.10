...
import dgtools.api.IHeldItemHUD;
import dgtools.api.IRenderInventoryItem;
import dgtools.common.DGMain;
import dgtools.common.entities.EntityTaintBubble;
import dgtools.client.model.ModelKatana;
import dgtools.client.model.ModelSaya;
import dgtools.common.network.PacketHandler;
import dgtools.common.network.PacketKatanaAttack;
...
public class ItemKatana extends Item implements IWarpingGear, IRepairable, IRenderInventoryItem, IHeldItemHUD
{
	...
	public static final ResourceLocation textureThaumium = new ResourceLocation("dg:models/ModelKatanaThaumium.png");
	public static final ResourceLocation textureVoidmetal = new ResourceLocation("dg:models/ModelKatanaVoidmetal.png");
	public static final ResourceLocation textureShadowmetal = new ResourceLocation("dg:models/ModelKatanaShadowmetal.png");
	...
	public void onPlayerStoppedUsing (ItemStack s, World w, EntityPlayer p, int i)
	{
		...
		if (!hasAnyInscription(s) || !isFullyCharged(p) || p.isSneaking() || getInscription(s) == 2)
		{
			...
			p.worldObj.playSoundAtEntity(p, "dg:swing", 0.5F + (float) Math.random(), 0.5F + (float) Math.random());
		}
