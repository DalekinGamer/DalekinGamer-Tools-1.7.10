...
public class ItemBlockMysticalwoodLeaves extends Block implements IShearable
{
	int[] adjacentTreeBlocks;
	private IIcon opaqueIcon;
	private IIcon transparentIcon;

	public ItemBlockMysticalwoodLeaves ()
	{
		...
		this.setBlockName("ItemBlockMysticalwoodLeaves");
	}
	...
	{
		opaqueIcon = ir.registerIcon("dg:mysticalwoodleaveslow");
		transparentIcon = ir.registerIcon("dg:mysticalwoodleaves");
	}
	...
	public void dropBlockAsItemWithChance (World w, int x, int y, int z, int m, float f, int i)
	{
		if ( (!w.isRemote) && ( (m & 0x8) != 0) && ( (m & 0x4) == 0))
		{
			...
			{
				dropBlockAsItem(w, x, y, z, new ItemStack(BlockRegistry.ItemBlockMysticalwoodSapling));
			}
		}
	}
